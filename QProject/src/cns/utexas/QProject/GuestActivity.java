...
public class GuestActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		{
			case R.id.add_icon:
				Intent intent = new Intent(GuestActivity.this, AddSongsGuest.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
	   ...
	   private class MyListAdapter extends ArrayAdapter<Song>{ 
			...
			up_button.setOnClickListener(new View.OnClickListener() {
		        @Override
		        public void onClick(View v) {
					Intent intent = new Intent(GuestActivity.this, GuestUpVote.class);
				    startActivity(intent);
		        }
		    });
		...
		public MyListAdapter(){
			super(GuestActivity.this, R.layout.song_individual, songs);
		}
	   }
