...
public class GuestDownVote extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		{
			case R.id.add_icon:
				Intent intent = new Intent(GuestDownVote.this, AddSongActivity.class);
	   ...
	   private class MyListAdapter extends ArrayAdapter<Song>{ 
			...
			down_button.setOnClickListener(new View.OnClickListener() {
		        ...
		        public void onClick(View v) {
					Intent intent = new Intent(GuestDownVote.this, GuestActivity.class);
				    startActivity(intent);
		        }
		    });
			...
			up_button.setOnClickListener(new View.OnClickListener() {
		        @Override
		        public void onClick(View v) {
					Intent intent = new Intent(GuestDownVote.this, LoginActivity.class);
				    startActivity(intent);
		        }
		    });
		...
		public MyListAdapter(){
			super(GuestDownVote.this, R.layout.song_individual, songs);
		}
	   }
		private void populateSongList() {
			songs.add(new Song(1, "All I want for Christmas", R.drawable.michaelbuble, "Michael Buble", 10, 1));
			songs.add(new Song(2, "Shake it Off", R.drawable.taylorswift, "Taylor Swift", 11, 3));
			songs.add(new Song(3, "Counting Stars", R.drawable.nativealbum, "One Republic", 4, 1));
			songs.add(new Song(4, "Sky Full of Stars", R.drawable.coldplay, "Coldplay", 2, 7));
