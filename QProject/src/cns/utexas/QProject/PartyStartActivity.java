...
public class PartyStartActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View.OnClickListener splistener = new View.OnClickListener() {
		...
		startpause.setOnClickListener(splistener);
	}
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		{
			case R.id.add_icon:
				Intent intent = new Intent(PartyStartActivity.this, AddSongActivity.class);
	   ...
	   private class MyListAdapter extends ArrayAdapter<Song>{ 
			...
			veto_button.setOnClickListener(new View.OnClickListener() {
		        @Override
		        public void onClick(View v) {
					Intent intent = new Intent(PartyStartActivity.this, VetoActivity.class);
				    startActivity(intent);
		        }
		    });
			return itemView;
		...
		public MyListAdapter(){
			super(PartyStartActivity.this, R.layout.party_start_song_individual, songs);
		}
	   }
