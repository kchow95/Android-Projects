...
public class GuestUpVote extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		{
			case R.id.add_icon:
				Intent intent = new Intent(GuestUpVote.this, AddSongActivity.class);
	   ...
	   private class MyListAdapter extends ArrayAdapter<Song>{ 
			...
			down_button.setOnClickListener(new View.OnClickListener() {
		        ...
		        public void onClick(View v) {
					Intent intent = new Intent(GuestUpVote.this, GuestDownVote.class);
				    startActivity(intent);
		        }
		    });
			...
			up_button.setOnClickListener(new View.OnClickListener() {
		        @Override
		        public void onClick(View v) {
					Intent intent = new Intent(GuestUpVote.this, GuestActivity.class);
				    startActivity(intent);
		        }
		    });
		...
		public MyListAdapter(){
			super(GuestUpVote.this, R.layout.song_individual, songs);
		}
	   }
		private void populateSongList() {
			songs.add(new Song(2, "Shake it Off", R.drawable.taylorswift, "Taylor Swift", 11, 2));
